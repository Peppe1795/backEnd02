...
public static void stampaDueRettangoli(Rettangolo primo, Rettangolo secondo) {
	...
	System.out.println("il perimetro del primo rettangolo è: " + perimetro + " l'area del primo rettangolo è: " + area);
	System.out.println("il perimetro del secondo rettangolo è: " + perimetro2 + " l'area del secondo rettangolo è: " + area2);
